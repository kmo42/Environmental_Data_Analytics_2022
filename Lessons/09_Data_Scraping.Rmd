...
avg_withdrawals <- webpage %>% 
  ...
  html_text()
avg_withdrawals   #.table:nth-child(7) td:nth-child(3) , .table:nth-child(7) td:nth-child(7)

max_withdrawals <- webpage %>% 
  html_nodes('.table:nth-child(7) td:nth-child(8) , .table:nth-child(7) td:nth-child(4)') %>%
  html_text()
max_withdrawals  #.table:nth-child(7) td:nth-child(8) , .table:nth-child(7) td:nth-child(4)
```
