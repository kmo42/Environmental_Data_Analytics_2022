...
#add letters with stat_summary (geom = "text", fun.y=max) for funcion of where to place the text (which max equals maximum; 
#vjustmeans vertianckl boxlots 
#labs(x="", y= ")
#adfust limits to be able to see label a with ylim
