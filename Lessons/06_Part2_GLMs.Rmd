...
##over .05 p value means follows a normal distr and do not reject the null, mening variables are not equal 
...
#results: reject null hypothesis if p value is less than 0.05 meaning the means are not all the same
...
###summary from aov is classic, lm has a row per variable all based on intercept term
...
# Post-hoc test: tells us which mean pairs are different 
